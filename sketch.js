...
let engine;
let world;
var rope,fruit,ground,rope2,ground2;
...
function setup() {
  ...
  rope = new Rope(5,{x:225,y:300});
  rope2 = new Rope(5,{x:55,y:400});
  ground = new Ground(200,690,600,20);
  ground2 = new Ground(255,175,100,10);
  ...
  bubble = createSprite(320,500,50,50);
  bubble.scale =  0.2;
